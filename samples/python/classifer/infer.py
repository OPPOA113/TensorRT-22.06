...
#
"""
infer.py: trt.engine 模型进行inference
"""
...
class TensorRTInfer:
    """
    Implements inference for classifer ,eg.EfficientNet, TensorRT engine.
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("-p", "--preprocessor", default="RESNET", choices=["V1", "V1MS", "V2", "RESNET"],
                        help="Select the image preprocessor to use, either 'V2', 'V1', 'V1MS' or 'RESNET', default: RESNET")
