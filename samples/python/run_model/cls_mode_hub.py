...
parse.add_argument("--save_dir", type=str, default=r"/workspace/project/projects/VastDeploy_v0.4.0/onnx_models/torchvision_onnx/")
parse.add_argument("--size", type=int, default=224)
parse.add_argument("--batchsize", type=int, default=1)
parse.add_argument(
    "--pretrained_weights",
    type=str,
    default=r"/workspace/project/projects/VastDeploy_v0.4.0/onnx_models/torchvision/resnet50-19c8e357.pth",
