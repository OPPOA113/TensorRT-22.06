...
#     onnx = '/home/rzhang/Desktop/yolov3aaa.onnx'

#     LOGGER.info(f'\n{prefix} starting export with TensorRT {trt.__version__}...')
#     # assert onnx.exists(), f'failed to export ONNX file: {onnx}'
#     assert os.path.exists(onnx), f'failed to export ONNX file: {onnx}'
#     # f = file.with_suffix('.engine')  # TensorRT engine file
#     f = 'test.engine'
#     logger = trt.Logger(trt.Logger.INFO)
#     if verbose:
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='../yolov3.pth', help='model.pt path(s)')   #default=ROOT / 'yolov5s.pt'
