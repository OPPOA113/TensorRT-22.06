        ...
        for input in inputs:
            ...
            if input.shape[0] == -1:
                ...
                if dynamic_batch_size:
                    ...
                    log.info("set_shape {} {} {}".format(min_shape,opt_shape, max_shape ))
                ...
                # static batch_size. trt模型的bs,与onnx模型bs严格相等
                assert input.shape[0] > 0
                self.builder.max_batch_size = batch_size
                log.info("Input '{}'static batch_size. set profile with shape {}".format(input.name, input.shape))
