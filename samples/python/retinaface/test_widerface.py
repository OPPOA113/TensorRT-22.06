...
parser.add_argument('-e', '--engine_model', default='./engine/retina_r50_1_640x640_fp32.engine',
                    type=str, help='serialization file path to open')
parser.add_argument('--input_size_w', default=320,type=int, help='engine input size of width')
parser.add_argument('--input_size_h', default=320,type=int, help='engine input size of height')
parser.add_argument('--save_folder', default='./widerface_evaluate/widerface_txt/', type=str, help='Dir to save txt results')

# parser.add_argument('--cpu', action="store_true", default=False, help='Use cpu inference')
parser.add_argument('--dataset_folder', default='/workspace/project/dataset/benchmarch_data/widerface/val/images/', type=str, help='dataset path')
...
# #defined in decode.h
INPUT_H=args.input_size_w
INPUT_W=args.input_size_h
# ## detetion CONF_THRESH 0.75 ;  map=>0.02
...
class Retinaface_trt(object):
    ...
    def infer(self, input_image_path):
        ...
        # ------------save result txt-------------------------------------
        parent_folder, img_name = os.path.split(input_image_path)
        save_name = args.save_folder +"/" + parent_folder[parent_folder.rfind('/')+1:]+ \
                                      "/" + img_name[:-4] + ".txt"
        ...
        with open(save_name, "w") as fd:
            ...
            for i in range(len(bboxs)):
                ...
                confidence = str(result_scores[i].numpy())
        ...
        if args.save_image:
            ...
            save_name = os.path.join(args.save_folder, "output_" + filename)
...
if __name__ == "__main__":
    ...
    PLUGIN_LIBRARY = "build/libdecodeplugin.so"
    ctypes.CDLL(PLUGIN_LIBRARY)
    engine_file_path = args.engine_model
